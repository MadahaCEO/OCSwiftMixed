...
//        NSString *resourceName =[[NSBundle mainBundle] pathForResource:@"unicode_to_hanyu_pinyin" ofType:@"txt"];
        NSString *resourceName =[[NSBundle bundleForClass:[self class]] pathForResource:@"MDH_unicode_to_hanyu_pinyin" ofType:@"txt"];
...
+ (MDHChineseToPinyinResource *)getInstance {
    static MDHChineseToPinyinResource *sharedInstance=nil;
