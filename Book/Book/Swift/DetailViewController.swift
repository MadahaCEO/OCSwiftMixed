...
@objc public class DetailViewController: UIViewController {
    ...
    @objc func writeContactsToDB() {
        ...
        concurrentQueue.async {
            ...
            let people = ["刘备","关羽","张飞","诸葛亮","吕布","赵云","典韦","马超","黄忠","许褚","孙策","太史慈","夏侯敦","夏侯渊","张辽","张颌","徐晃","庞德","甘宁","周泰","魏延","张锈","文丑","颜良","邓艾","姜维","荀彧","荀攸","贾诩","郭嘉","程昱","刘晔","蒋济","陈群","华歆","钟繇","满宠","董昭","王朗","崔琰","毛玠","杜畿","田畴","王修","杨修","辛毗","杨阜","田豫","王粲","蒯越","张继","杜袭","枣祗","孙乾","简雍","简雍"]
